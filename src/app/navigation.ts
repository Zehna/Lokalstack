...
export type FeatureGroup = 'dashboard' | 'projects' | 'services' | 'ports' | 'workspaces' | 'ai-services' | 'docker' | 'history' | 'settings' | 'diagnostics'
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'diagnostics', label: 'Diagnostics', feature: 'diagnostics' },
]
